...
export default function Comments({ snippetId }: Props) {
  ...
  return (
    <div className="bg-[#121218] border border-[#ffffff0a] -2xl overflow-hidden">
      ...
      <div className="p-6 sm:p-8">
        {user ? (
          ...
          <div className="bg-[#0a0a0f] -xl p-6 text-center mb-8 border border-[#ffffff0a]">
            <p className="text-[#808086] mb-4">
              Sign in to join the discussion
            </p>
            <SignInButton mode="modal">
              <button className="px-6 py-2 bg-[#3b82f6] text-white -lg hover:bg-[#2563eb] transition-colors">
                Sign In
              </button>
            </SignInButton>
          </div>
